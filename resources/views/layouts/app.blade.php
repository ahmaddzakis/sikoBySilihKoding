...
<body
    class="min-h-screen font-sans antialiased selection:bg-purple-500 selection:text-white"
    x-data="layoutData()"
>

    <!-- ================= NAVBAR ================= -->
    <header
        class="sticky top-0 bg-[#1a161f]/90 backdrop-blur-md z-50 border-b border-transparent transition-all"
        ...
        <div class="max-w-6xl mx-auto px-6 h-16 flex justify-between items-center relative">
            ...
            <div class="flex items-center gap-6 text-sm text-gray-400">
                ...
                <button class="hover:text-white transition-colors relative">
                    ...
                    <span
                        class="absolute -top-1 -right-0.5 w-2 h-2 bg-red-500 rounded-full border-2 border-[#1a161f]">
                    </span>
                </button>
