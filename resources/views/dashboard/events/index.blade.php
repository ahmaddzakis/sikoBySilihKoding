            ...
            <div class="flex flex-col md:flex-row justify-between items-center mb-6 gap-4">
                ...
                <div class="flex gap-4 w-full md:w-auto">
                    ...
                    <a href="{{ route('dashboard.events.create') }}"
                        class="flex items-center gap-2 bg-sky-600 hover:bg-sky-700 text-white font-bold px-6 py-2 rounded-lg transition-all shadow-md hover:shadow-lg transform active:scale-95 whitespace-nowrap">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor">
