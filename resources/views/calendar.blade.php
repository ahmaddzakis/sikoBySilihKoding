...
<div class="max-w-6xl mx-auto px-6 py-10">
    ...
    <div class="mb-12">
        <div class="flex justify-between items-center mb-4">
            ...
            <button class="flex items-center gap-2 px-3 py-1.5 bg-surface/50 border border-border hover:bg-surfaceHover rounded text-sm font-medium transition-colors text-white">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="bg-surface border border-border rounded-xl p-6 hover:border-textMuted transition-colors cursor-pointer group h-full">
                <div class="flex flex-col items-start gap-3">
                    <!-- Avatar -->
                    <div class="w-12 h-12 rounded-full bg-gradient-to-tr from-green-400 to-blue-500 border border-border"></div>
                    
                    <div class="mt-1">
                        <h3 class="font-bold text-base text-white group-hover:text-white transition-colors">Mustika</h3>
                        <p class="text-sm text-textMuted group-hover:text-white/80 transition-colors">0 Pelanggan</p>
                    </div>
                </div>
            </div>
        </div>
